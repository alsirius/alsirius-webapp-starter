...
class EmailManager {
    ...
    async sendInvitationEmail(email, firstName, inviteCode, inviterName) {
        if (!this.transporter) {
    ...
    generateInvitationTemplate(firstName, inviteCode, inviterName) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    generateVerificationTemplate(verificationCode) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    generatePasswordResetTemplate(resetToken) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
